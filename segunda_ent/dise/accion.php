...
<head>
    ...
    <link rel="stylesheet" href="../negocio/usuario/index.css">
        ...
        <div class="Contenido border-b border-red-500 py-5 mr-5  h-screen w-full">
            ...
            <div class="flex h-auto flex-col">
                <form class="form" name="formulario" >
                    <h3>  USUARIOS </h3>
                    <a href="../negocio/usuario/agregar.php">Agregar nuevo usuario</a>
                    ...
                    <br />
                    <h3>  PROVEEDORES </h3>
                    <a href="../negocio/proveedor/agregar_prov.php">Agregar nuevo proveedor</a>
                    ...
                    <br />
                    <h3>  PRODUCTOS </h3>
                    <a href="../negocio/productos/agregar_prod.php">Agregar nuevo producto</a>
                    <!-- <a href="../negocio/Upd_prov.php">Modificar producto</a> -->
                    <a href="../negocio/productos/eliminar_prod.php">Eliminar producto</a>
                    <br />
                    <br />
