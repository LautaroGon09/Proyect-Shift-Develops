...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../usuario/index.css">
...
<div id="menu" class="w-full mt-5 hidden flex-grow md:flex md:items-center md:w-auto text-end mr-10">
  <div  class="text-md md:flex-grow text-center items-cenetr mb-5  md:text-end justify-center items-cenetr ">
    ...
    <a href="../usuario/login.php" class="block w-full md:w-auto mt-4 md:inline-block md:mt-0 text-white hover:text-white">
      iniciar sesion
    </a>  
  </div>
    ...
    <div class="flex flex-col w-full mt-20">
      <div class="flex h-screen flex-col">
        ...
        <form class="form" name="formulario" method="post" action="">
            ...
            <input class="controls" placeholder="Nombre Producto" type="text" name="nom2" value="<?php echo $nom; ?>" required maxlength="30" size="40">

            <input class="controls" placeholder="Stock" type="number" min="1" name="sto2" value="<?php echo $sto; ?>" required maxlength="30" size="40">

            <input class="controls" placeholder="Precio" type="number" min="1" name="pre2" value="<?php echo $pre; ?>" required maxlength="30" size="40">

            <input class="controls" placeholder="Descripcion Producto" type="text" name="desc2" value="<?php echo $desc; ?>" required maxlength="30" size="40">

            <input class="botons" type="submit" value="Modificar" name="modificar">
            <a href="mostrar_prod.php">Regresar</a>
        </form>
            <br />
            <div class="flex flex-col mx-auto mt-20">
            <?php include("funcEditarProd.php")?>
            </div>
        </div>
